...
class MDP:
    def __init__(self, transition_probs, rewards, initial_state=None, seed=None):
        ...
        Args:
            transition_probs: transition_probs[s][a][s_next] = P(s_next | s, a)
            A dict[state -> dict] of dicts[action -> dict] of dicts[next_state -> prob]
            For each state and action, probabilities of next states should sum to 1
            If a state has no actions available, it is considered terminal

            rewards: rewards[s][a][s_next] = r(s,a,s')
            A dict[state -> dict] of dicts[action -> dict] of dicts[next_state -> reward]
            The reward for anything not mentioned here is zero.

            initial_state: a state where agent starts or a callable() -> state
    ...
    def get_all_states(self):
        ...
        Returns:
            tuple: contains all possible states
        """
    ...
    def get_possible_actions(self, state):
        ...
        Returns:
            tuple: contains all possible actions in a given state
        """
    ...
    def is_terminal(self, state):
        ...
        Returns:
            bool: True if state is terminal or False if it isn't
        """
    ...
    def get_next_states(self, state, action):
        ...
        Returns:
            dict: {next_state1 : P(next_state1 | state, action), next_state2: ...}
        """
    ...
    def get_transition_prob(self, state, action, next_state):
        ...
        Returns:
            float: P(next_state | state, action)
        """
    ...
    def get_reward(self, state, action, next_state):
        ...
        Returns:
            float: reward you get for taking action in state and landing on next_state
        """
        assert action in self.get_possible_actions(state), "cannot do action %s from state %s" % (action, state)
    ...
    def reset(self):
        ...
        Raises:
            ValueError: initial state should be either a state or a function()
    ...
    def _check_param_consistency(self, transition_probs, rewards):
        ...
        Args:
            transition_probs (dict): transition probs
            rewards (dict): reward for the state
        """
    ...
    def __init__(self, desc=None, map_name="4x4", slip_chance=0.2, seed=None):
        ...
        def move(row, col, movement):
            ...
            Args:
                row (int): current row
                col (int): current col
                movement (string): direction of movement
